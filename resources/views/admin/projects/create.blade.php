    ...
    <div class="max-w-4xl mt-10 mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
            ...
            <div class="flex flex-row justify-between items-center">
                ...
                <a href="{{ route('dashboard.wallet.topup') }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                    Topup Wallet
                </a>
            </div>
                ...
                <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="skill_level" id="skill_level" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            <option value="" disabled selected>Choose skill_level</option>
