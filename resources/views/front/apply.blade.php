      ...
      <section id="details" class="container max-w-[1130px] mx-auto flex flex-col sm:flex-row sm:flex-nowrap gap-5 mt-[30px]">
        <div class="flex flex-col gap-5">
            ...
            <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px] h-fit">
                ...
                <form action="{{ route('front.apply_job.store', $project) }}" class="flex flex-col gap-5" method="POST">
                    @csrf
                    <div class="flex p-[14px_20px] border border-[#030303] rounded-[20px] gap-[10px]">
                        ...
                        <textarea name="message" id="" rows="8" class="focus:outline-none appearance-none font-medium leading-[30px] placeholder:font-normal placeholder:text-[#545768] w-full resize-none" placeholder="Write your experience related to this project"></textarea>
                    </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col gap-[2px]">
                        ...
                        <p class="text-sm leading-[21px] text-[#545768]">
                            {{ $project->owner->projects->count() }} Total Projects
                        </p>
                    </div>
                </div>
